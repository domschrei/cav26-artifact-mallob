...
BENCHMARKFILE=scripts/selection-sat-demo-small.txt BASEDIR=$basedir/$suite_idx-c$scale-sat-mixed/ \
scripts/run-benchmark.sh -mono-app=SAT -satsolver=kcl

banner_run_suite "[${scale}x] SAT solving, monolithic proof production"
BENCHMARKFILE=scripts/selection-sat-demo-small.txt BASEDIR=$basedir/$suite_idx-c$scale-sat-monolproof/ \
MONOPROOF=1 scripts/run-benchmark.sh -mono-app=SAT

banner_run_suite "[${scale}x] SAT solving, real-time proof checking"
BENCHMARKFILE=scripts/selection-sat-demo-small.txt BASEDIR=$basedir/$suite_idx-c$scale-sat-rtcheck/ \
scripts/run-benchmark.sh -mono-app=SAT -otfc=1 -otfci=1

banner_run_suite "[${scale}x] SAT solving, streamlined preprocessing"
BENCHMARKFILE=scripts/selection-sat-demo-small.txt BASEDIR=$basedir/$suite_idx-c$scale-sat-streamlined/ \
