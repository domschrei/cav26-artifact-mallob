...
if not args.nolegend:
    if args.legendright:
        leg = plt.legend(bbox_to_anchor=(1.05, 0.5), loc='center left', edgecolor="black", labelspacing=args.legend_spacing, handletextpad=0.01, alignment="right")
    else:
        leg = plt.legend(loc=args.lloc, handletextpad=0.01, labelspacing=args.legend_spacing, alignment="right")
