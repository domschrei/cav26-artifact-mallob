...
cd artifact
    ...
    cd mallob-cav26
        ...
        bash scripts/setup/cmake-make.sh build -DMALLOB_MAX_N_APPTHREADS_PER_PROCESS=64 -DMALLOB_APP_SMT=1 -DMALLOB_APP_MAXSAT=1 -DMALLOB_APP_SATWITHPRE=1 -DMALLOB_BUILD_IMPCHECK=1
